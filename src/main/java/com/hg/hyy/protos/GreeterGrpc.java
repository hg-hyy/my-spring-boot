 ...
 * </pre>
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.41.0)", comments = "Source: helloworld.proto")
...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hg.hyy.protos.HelloRequest, com.hg.hyy.protos.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
      + "SayHello", requestType = com.hg.hyy.protos.HelloRequest.class, responseType = com.hg.hyy.protos.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hg.hyy.protos.HelloRequest, com.hg.hyy.protos.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.hg.hyy.protos.HelloRequest, com.hg.hyy.protos.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod = io.grpc.MethodDescriptor.<com.hg.hyy.protos.HelloRequest, com.hg.hyy.protos.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello")).setSampledToLocalTracing(true)
              .setRequestMarshaller(
                  io.grpc.protobuf.ProtoUtils.marshaller(com.hg.hyy.protos.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(
                  io.grpc.protobuf.ProtoUtils.marshaller(com.hg.hyy.protos.HelloReply.getDefaultInstance()))
              .setSchemaDescriptor(new GreeterMethodDescriptorSupplier("SayHello")).build();
        }
      }
    }
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.hg.hyy.protos.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hg.hyy.protos.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(getSayHelloMethod(),
              io.grpc.stub.ServerCalls
                  .asyncUnaryCall(new MethodHandlers<com.hg.hyy.protos.HelloRequest, com.hg.hyy.protos.HelloReply>(this,
                      METHODID_SAY_HELLO)))
          .build();
    }
  }
  ...
  public static final class GreeterStub extends io.grpc.stub.AbstractAsyncStub<GreeterStub> {
    ...
    public void sayHello(com.hg.hyy.protos.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hg.hyy.protos.HelloReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(getChannel().newCall(getSayHelloMethod(), getCallOptions()), request,
          responseObserver);
    }
  }
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
     ...
     * </pre>
     */
    public com.hg.hyy.protos.HelloReply sayHello(com.hg.hyy.protos.HelloRequest request) {
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hg.hyy.protos.HelloReply> sayHello(
        com.hg.hyy.protos.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements io.grpc.stub.ServerCalls.UnaryMethod<Req, Resp>,
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      ...
      case METHODID_SAY_HELLO:
        serviceImpl.sayHello((com.hg.hyy.protos.HelloRequest) request,
            (io.grpc.stub.StreamObserver<com.hg.hyy.protos.HelloReply>) responseObserver);
        break;
      default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hg.hyy.protos.HelloWorldProto.getDescriptor();
    }
  ...
  private static final class GreeterMethodDescriptorSupplier extends GreeterBaseDescriptorSupplier
      ...
      synchronized (GreeterGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new GreeterFileDescriptorSupplier()).addMethod(getSayHelloMethod()).build();
        }
      }
    }
    return result;
