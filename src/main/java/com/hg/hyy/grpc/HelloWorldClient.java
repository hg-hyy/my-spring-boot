...
import com.hg.hyy.protos.GreeterGrpc;
import com.hg.hyy.protos.HelloReply;
import com.hg.hyy.protos.HelloRequest;
...
public class HelloWorldClient {
  ...
  public void greet(String name) {
    log.error("Will try to greet " + name + " ...");
    ...
    log.error("Greeting: " + response.getMessage());
  }
   ...
   */
  public static void grpcC() throws Exception {
    String user = "world";
